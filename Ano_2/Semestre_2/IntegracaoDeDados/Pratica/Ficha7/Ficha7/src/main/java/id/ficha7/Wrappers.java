...
public class Wrappers {
    ...
    public static Livro criaLivro(String isbn) throws IOException, SaxonApiException {
        String xp = "//livro[@isbn='" + isbn + "']";
        XdmValue res = null;
        res = XPathFunctions.executaXpath(xp, "livro.xml");
        ...
        if (res == null || res.size() == 0) { //Livro não existe
            ...
            Livro x = new Livro(isbn, titulo, autor,capa, editor, pag, preco,00);
            return x;
        }
        return null;
    }
